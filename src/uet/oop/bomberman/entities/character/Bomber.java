...
public class Bomber extends Character {
    ...
    private void detectPlaceBomb() {
        ...
        Entity currentLocation = _board.getEntity(getXTile(),getYTile(),null);
        if(_input.space && Game.getBombRate() > 0 && _timeBetweenPutBombs < 0 ) {

            int x,y;
            x = Coordinates.pixelToTile(_x + _sprite.getSize() / 2);
            y = Coordinates.pixelToTile((_y + _sprite.getSize() / 2) - _sprite.getSize());
            placeBomb(x,y);
            Game.addBombRate(-1);
